...
// Reading photographs and PDFs into structured figures: invoices, expenses and
// documents. The end-of-day POS report reader that this file opened with is
// gone — it was used once, and every figure it produced still had to be checked
// by hand on the close screen, which was the work it existed to save. The close
// screen is typed into directly now.
